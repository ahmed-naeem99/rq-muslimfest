  ...
  return (
    <div className="w-full flex flex-col items-center gap-3">
      <button
        ...
        className="disabled:opacity-40 flex w-3/4 justify-center rounded-md bg-red-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500"
      >
        {hintsUsed > hintNum - 1
          ? `Show Hint ${hintNum}`
